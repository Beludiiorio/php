...
class Producto //Es POO por eso la clase comienza en mayuscula y las entidades en singular
{
    private $idproducto; //Se corresponden a las columnas de la base de datos
    private $nombre;
    private $cantidad;
    private $precio;
    private $descripcion;
    ...
    {
            $this -> cantidad= 0.0; //Para acceder desde la propia clase a las propiedades es  con $this:
            $this -> precio= 0.0;
    }
    ...
    public function insertar()
    {
        ...
        $sql = "INSERT INTO productos ( #El metodo insert tiene 4 partes, se conecta a la BBDD, utiliza el programa mySQLI, crea el objeto mySQLI.
                    nombre,
                    cantidad,
                    precio,
                    descripcion,
                    ...
                    '$this->nombre', #Las comillas van solo para los string
                    '$this->cantidad,
                    '$this->precio,
                    '$this->descripcion',
                    '$this->imagen',
