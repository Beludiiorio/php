...
<head>
    <!-- Es la configuracion que le indicamos al ordenador -->
    <meta charset="UTF-8">
    <!--Para que acepte los caracteres del español -->
...
<body>
    ...
    <main class="container">
        <div class="row">
            <!-- Hace que la pagina se comporte como una grilla de 12 columnas. Container deja un margen en los laterales y container fluid ocupa el 100% de la pantalla -->
        ...
        <div class="row">
            ...
            <div class="col-12 text-center">
                <table class="table table-hover border">
                    <!-- Estructura de tabla con sombreado y borde-->
                    <tr>
                        <th>DNI</th>
                        <!--Encabezado (Es una tabla con 3 columnas) -->
                        <th>Nombre</th>
                        <th>Sueldo</th>
                    </tr>

                    <?php for ($i = 0; $i < count($aEmpleados); $i++) { ?>
                        <!--Abrimos y cerramos php otra vez en una sola linea, es un for que repite un ciclo mientras se cumpla una condicion (mientras $i sea menor a la cantidad de empleados) -->
                        <tr>
                            <td><?php echo $aEmpleados[$i]["dni"] ?> </td>
                            <td><?php echo mb_strtoupper($aEmpleados[$i]["nombre"]); ?> </td>
                            <!--mb_strtoupper es una funcion que nos da php para convertir en mayuscula -->
                            <td><?php echo number_format(calcularNeto($aEmpleados[$i]["bruto"]), 2, ",", ".") ?> </td>
                            <!--El formato dice que tiene 2 decimales, el separador decimal es la coma y el separador de miles el punto.   -->
                        </tr>
                    <?php } ?>
                </table>
            </div>
